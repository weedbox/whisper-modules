...
func getUploader() *Uploader {
	...
	app := fx.New(
		...
		fx.Provide(func(p Params) *Uploader {
			...
			u.datastore = "./datastore"
			u.archivestore = "./archivestore"
...
func (s *TestSuite) TestZUpdateIndex() {
	...
	archivename := "archivestore/100/100/MSG_99999.db"
...
func BenchmarkUpdateIndex(b *testing.B) {
	...
	archivename := "archivestore/100/100/MSG_%d.db"
